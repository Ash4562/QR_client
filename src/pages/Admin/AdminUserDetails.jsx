    ...
    <>
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex flex-col w-full px-6 py-4 bg-white shadow-[0px_4px_6px_rgba(0,0,0,0.1)] border rounded-lg mt-20 sm:mt-20 md:mt-0">
          <div className="flex items-center gap-4 mb-6 sticky">
            {/* Search Input */}
            <div className="relative flex-1">
              <input
                type="text"
                className="w-full border border-gray-300 px-10 py-2 focus:outline-none rounded-3xl font-poppins shadow-[0_4px_4px_0_rgba(0,0,0,0.25)] placeholder:text-sm"
                placeholder="Search"
              />
          ...
          <div className="flex  flex-col justify-center items-center bg-[#ECF8F9] ">
            <div className="w-full max-w-4xl mt-5 bg-white border border-gray-300 rounded-3xl shadow-lg p-8 overflow-y-auto" style={{ maxHeight: '70vh' }}>
              {/* Profile Picture */}
